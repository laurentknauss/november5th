...
import { uniswapWallet, ledgerWallet, coreWallet, metaMaskWallet, rainbowWallet,  safeWallet, trustWallet  } from '@rainbow-me/rainbowkit/wallets';
  ...
  [
    {
      ...
      wallets: [coreWallet, metaMaskWallet, uniswapWallet, rainbowWallet, ledgerWallet,  safeWallet, trustWallet], 
    },  
  ], 
