...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen py-0">
      <div className="w-full bg-amber-700 text-white py-2 px-4 text-center font-bold">
      ...
      <main className="flex flex-col items-center w-full flex-1 px-14 text-center pt-0">
        ...
        {!mounted ? (
          ...
          <div className="space-y-6">
            <p className="text-xl text-gray-800 pt-2 pb-8 mt-6 px-6 py-4 bg-gray-100 bg-opacity-90 rounded-lg shadow-lg border border-gray-300">Please connect your wallet to participate in the secure blockchain-based voting process</p>
