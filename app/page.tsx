...
export default function Home() {
  ...
  const { data: votes1 } = useContractRead({
  ...
  const { data: votes2 } = useContractRead({
    address: contractAddress,
    abi: abi,
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <h1 className="text-6xl font-bold">Decentralized Voting Dapp</h1>
        <p className="mt-3 text-2xl"><strong>Cast your vote for the next US president on the blockchain !!</strong></p> 
        <div className="mt-10">
          {isConnected ? (
            <div>
